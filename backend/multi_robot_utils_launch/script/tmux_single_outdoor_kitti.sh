...
BAG_PLAY_RATE=1.0
BAG_DIR="${SLIDE_SLAM_BAG_DIR:-/opt/bags/vems-slam-bags/all_slide_slam_public_demos/kitti_bags}"
...
tmux send-keys -t $SESSION_NAME "$SETUP_ROS_STRING; sleep 10; cd $BAG_DIR && ros2 bag play kitti-slide-slam-0* --clock -r $BAG_PLAY_RATE --start-offset 0 --remap /aft_mapped_to_init:=/Odometry /semantic_point_cloud:=/os_node/segmented_point_cloud_no_destagger_high_freq" Enter
